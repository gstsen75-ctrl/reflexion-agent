...
-Add a "references" section to the bottom of your answer (which does not count towards the word limit.)
    Eg: - [1] https://example.com
        - [2] https://example.com
        - [3] https://example.com
-You should use the previous critique to remove superflous information from your answer and make SURE it doesn't exceed 250 words.
"""
